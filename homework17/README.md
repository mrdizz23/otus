...
| EXPLAIN                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| -> Nested loop inner join  (cost=21.1 rows=50.8) (actual time=0.226..0.444 rows=49 loops=1)
    -> Filter: (p.max_price is not null)  (cost=9.17..3.29 rows=7) (actual time=0.174..0.177 rows=7 loops=1)
        -> Table scan on p  (cost=10.5..12.7 rows=7) (actual time=0.172..0.174 rows=7 loops=1)
            -> Materialize  (cost=10.1..10.1 rows=7) (actual time=0.17..0.17 rows=7 loops=1)
                -> Covering index skip scan for grouping on products using idx_category_price  (cost=9.45 rows=7) (actual time=0.0688..0.136 rows=7 loops=1)
    -> Index lookup on t_max using idx_category_price (category=p.category, price=p.max_price)  (cost=1.92 rows=7.25) (actual time=0.0342..0.0371 rows=7 loops=7)
 |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
1 row in set (0.01 sec)
```
